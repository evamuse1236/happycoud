...
- `tools/check-mood-score.py` exercises recurring mood instrument phrases, ongoing base harmony, reading attenuation, removal on Show everything, silent selection, and light-menu bounds at desktop, 390px and 320px widths.
